...
class GemsListView(ListView):
    model = Gem
    template_name = 'admin_gems.html'
    paginate_by = 10
...
class GemsCreateView(CreateView):
    model = Gem
    template_name = 'admin_gems_create.html'
    success_url = '/admin/gems/'
    fields = ('__all__')
...
class GemsDeleteView(DeleteView):
    model = Gem
    success_url = '/admin/gems/'
...
class GemsUpdateView(UpdateView):
    model = Gem
    template_name = 'admin_gems_update.html'
    fields = ('__all__')
    success_url = '/admin/gems/'
...
class GemsDetailView(DetailView):
    model = Gem
    template_name = 'admin_gem_detail.html'
